...
export default function Buy() {
  ...
  const [swapButtonText, setSwapButtonText] = useState("Buy");
  ...
  return (
    <div>
          ...
          <div className=" bg-[#1A1F30] p-4 rounded-lg">
            <div className="flex ">
              <div className="pl-3 pe-4 p-2 flex flex-col items-end rounded-lg bg-[#3F4351] ">
                <div>
                  <p className="pb-1 opacity-65 text-xs">I will pay</p>
            ...
            <div className="flex ">
              <div className="pl-3 pe-4 p-2 flex flex-col items-end rounded-lg bg-[#3F4351] ">
                <div className="">
                  <p className="pb-1 opacity-65 text-xs">I will receive</p>
                  <div className="flex gap-x-24">
                    <div className="flex items-center rounded-md px-3 bg-[#292C33]  ">
                      <div className="flex items-center gap-2 text-sm py-1 ">
                        <div>
      ...
      <h3 className="mt-8 font-semibold">Steps to Buy crypto</h3>
        ...
        <div>
          ...
          <div className="border border-[#5275EC] rounded-bl-lg rounded-br-lg p-4">
            <p className="text-center opacity-85">
              Enter the desired amount of coin you want to buy, and select your
